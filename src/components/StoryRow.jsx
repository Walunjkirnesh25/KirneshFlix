    ...
    <section className="relative py-10 sm:py-14">
      <div className="mx-auto mb-5 flex max-w-7xl items-end justify-between px-6 sm:px-8">
        <div>
          ...
          {subtitle ? <p className="mt-1 text-[14px] text-frost-300">{subtitle}</p> : null}
        </div>
...
const Chevron = ({ direction, onClick }) => (
  ...
  >
    <svg width="14" height="14" viewBox="0 0 16 16" fill="none" aria-hidden>
      <path d={direction === 'left' ? 'M10 3L5 8l5 5' : 'M6 3l5 5-5 5'} stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  </button>
);
